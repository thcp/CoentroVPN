...
mod tests {
    ...
    fn test_serialize_deserialize_request() {
        ...
        let deserialized: ClientRequest = deserialize(&serialized).expect("Failed to deserialize request");
        ...
        match deserialized {
            ClientRequest::SetupTunnel(setup) => {
                ...
                assert_eq!(setup.dns_servers, Some(vec!["8.8.8.8".to_string(), "1.1.1.1".to_string()]));
    ...
    fn test_serialize_deserialize_response() {
        ...
        let deserialized: HelperResponse = deserialize(&serialized).expect("Failed to deserialize response");
